...
**96k** ⭐ [microsoft/playwright](https://github.com/microsoft/playwright) — [fix(routing): match ws(s) baseURL rewrite case-insensitively](https://github.com/microsoft/playwright/pull/41557)<br>
...
**41k** ⭐ [Hmbown/Codewhale](https://github.com/Hmbown/Codewhale) — [fix(command-safety): make python -m arity entries reachable…](https://github.com/Hmbown/Codewhale/pull/3588)<br>
...
**36k** ⭐ [solidjs/solid](https://github.com/solidjs/solid) — [fix(server): Show/Switch should ignore zero-arg function ch…](https://github.com/solidjs/solid/pull/2808)<br>
