...
<!-- EXTERNAL_PRS:START -->
`today` — [fix(types): correct `Model.validate()` return type to `Prom…](https://github.com/Automattic/mongoose/pull/16340) · [Automattic/mongoose](https://github.com/Automattic/mongoose) ⭐ 27.4k<br>
