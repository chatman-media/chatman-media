...
- `2 days ago` — [fix(locale): exclude forbidden letter combinations from nl…](https://github.com/faker-js/faker/pull/3888) · [faker-js/faker](https://github.com/faker-js/faker) ⭐ 15.3k
...
- `3 days ago` — [fix: correctly escape and quote custom quoteChar in unparse](https://github.com/mholt/PapaParse/pull/1124) · [mholt/PapaParse](https://github.com/mholt/PapaParse) ⭐ 13.4k
- `3 days ago` — [fix(hmr): preserve runtime-added properties of setup store…](https://github.com/vuejs/pinia/pull/3132) · [vuejs/pinia](https://github.com/vuejs/pinia) ⭐ 14.6k
...
**12 merged pull requests** to external projects with 5k+ stars · [full list of all 24](external-prs.md) · [on GitHub](https://github.com/search?q=is%3Apr+author%3Achatman-media+-user%3Achatman-media+is%3Amerged&type=pullrequests)
<!-- EXTERNAL_PRS:END -->

## 🧑‍💻 Work with me

**I take on a small number of serious projects** — production AI/LLM automation, custom software and product builds where engineering quality and a direct line to the person writing the code actually matter. 15+ years as a Lead/Senior engineer (Top-10 on GitHub in Thailand), shipping real systems end-to-end: an AI video editor, trading terminals, a crypto wallet, an RPA platform and mobile apps. Fixed scope and estimate up front, production-ready code, no open-ended billing. If that's your project — **[describe it on Telegram](https://t.me/alexanderkireev)**, I reply within a day.
...
**Беру небольшое число серьёзных проектов** — production AI/LLM-автоматизация, кастомный софт и продукты, где важны инженерное качество и прямой контакт с тем, кто пишет код. 15+ лет как Lead/Senior-инженер (Топ-10 GitHub в Таиланде), довожу до продакшена реальные системы: AI-видеоредактор, торговые терминалы, крипто-кошелёк, RPA-платформу, мобильные приложения. Фикс ТЗ и оценка до старта, production-ready код, без открытых счетов. Если это про ваш проект — **[опишите задачу в Telegram](https://t.me/alexanderkireev)**, отвечу в течение дня.
