...
**18 merged pull requests** to external projects with 5k+ stars · [full list of all 30](external-prs.md) · [on GitHub](https://github.com/search?q=is%3Apr+author%3Achatman-media+-user%3Achatman-media+is%3Amerged&type=pullrequests)
<!-- EXTERNAL_PRS:END -->
